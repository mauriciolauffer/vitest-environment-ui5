 ...
 * @vitest-environment-options { "path": "https://ui5.sap.com/1.120/test-resources/sap/m/demokit/orderbrowser/webapp/test/mockServer.html", "timeout": 200 }
 */
...
describe('Load test from URL', () => {
  it('ui5 env is defined', () => {
    const environmentOptions = globalThis?.__vitest_worker__?.ctx?.environment?.options;
    const ui5Options = {ui5: {path: 'https://ui5.sap.com/1.120/test-resources/sap/m/demokit/orderbrowser/webapp/test/mockServer.html'}};
